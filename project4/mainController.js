...
cs142App.controller('MainController', ['$scope', function($scope) {
   ...
   $scope.main.name = 'Umit';
   $scope.main.motto = 'Hello AngularJS!';
   $scope.main.currentView = 'example';
   $scope.main.nextView = 'states';

   $scope.main.switchView = function() {
      var temp = $scope.main.currentView;
      $scope.main.currentView = $scope.main.nextView;
      $scope.main.nextView = temp;
   };
}]);
